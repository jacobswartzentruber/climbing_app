...
ActiveRecord::Schema.define(version: 20150501150637) do
  ...
  add_index "projects", ["climber_id"], name: "index_projects_on_climber_id"
  add_index "projects", ["route_id"], name: "index_projects_on_route_id"
